...
def gather_data(args):
    ...
    for dtype in args.dtypes:
        ...
        print({"model_name":args.model_name, "dtype":dtype, "dtype_largest_layer":dtype_largest_layer, "dtype_total_size":dtype_total_size, "dtype_training_size":dtype_training_size})
    return data
